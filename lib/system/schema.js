module.exports = (m, env) => {
   ...
   if (setting) {
      ...
      if (!('owners' in setting)) setting.owners = ['254797606189']
      ...
      if (!('link' in setting)) setting.link = 'https://chat.whatsapp.com/D4OaImtQwH48CtlR0yt4F'
   } else {
      global.db.setting = {
         autodownload: true,
         antispam: false,
         ...
         link: 'https://chat.whatsapp.com/D4OaImtQwH48CtlR0yt4F'
      }
   }
}
