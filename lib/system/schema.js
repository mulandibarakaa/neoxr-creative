module.exports = (m, env) => {
   ...
   if (setting) {
      ...
      if (!('sk_author' in setting)) setting.sk_author = '© Ace.js'
      ...
      if (!('msg' in setting)) setting.msg = 'Hi +tag 🪸\nI am an automated system (WhatsApp Bot) that can help to do something, search and get data / information only through WhatsApp.\n\n◦ *Database* : +db\n◦ *Library* : Baileys v+version\n◦ *Telegram Premium* :https://t.me/AceAscend\n◦ *Source* : https://by-ace.vercel.app/\n\nIf you find an error or want to upgrade premium plan contact the owner.'
      if (!isNumber(setting.style)) setting.style = 4
      if (!('cover' in setting)) setting.cover = 'https://files.catbox.moe/o9bfas.jpeg'
      if (!('link' in setting)) setting.link = 'https://whatsapp.com/channel/0029VaKenMe0LKZEAnWle521'
   } else {
      global.db.setting = {
         autodownload: true,
         antispam: false,
         ...
         msg: 'Hi +tag 🪸\nI am an automated system (WhatsApp Bot) that can help to do something, search and get data / information only through WhatsApp.\n\n◦ *Database* : +db\n◦ *Library* : Baileys v+version\n◦ *Telegram Premium* :https://t.me/AceAscend \n◦ *Source* : https://by-ace.vercel.app/\n\nIf you find an error or want to upgrade premium plan contact the owner.',
         style: 4,
         cover: 'https://files.catbox.moe/o9bfas.jpeg',
         link: 'https://whatsapp.com/channel/0029VaKenMe0LKZEAnWle521'
      }
   }
}
